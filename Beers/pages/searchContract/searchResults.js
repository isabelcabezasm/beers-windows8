...
//  
// <script src="/pages/searchContract/searchResults.js"></script>
...
(function () {
    ...
    var searchPageURI = "/pages/searchContract/searchResults.html";
    ...
    ui.Pages.define(searchPageURI, {
        ...
        /* Implementar la funcion searchData: esta funcion devuelve una lista 
            *   (WinJS.Binding.List) que es la que muestra la pagina de resultados.*/
        searchData: function (queryText) {
            var originalResults;
            var regex;
            //Perform the appropriate search on your data.
            if (window.Data) {
                originalResults = Data.items.createFiltered(function (item) {
                    regex = new RegExp(queryText, "gi");
                    return (item.title.match(regex) || item.subtitle.match(regex) ||
                        item.features.match(regex) ||
                        (item.description != null && item.description.match(regex)));
                });
            } else {
        ...
        // This function colors the search term. Referenced in /pages/searchContract/searchResults.html
    ...
    appModel.Search.SearchPane.getForCurrentView().onsuggestionsrequested
     = function (eventObject) {
         var text = eventObject.queryText.toLowerCase();
         var terms = ["trigo", "cebada", "pale", "ale", "bitter", "pale ale", "turbia", "rubia", "tostada"];
