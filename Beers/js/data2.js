(function () {
    ...
    var groupList = new WinJS.Binding.List();

    var groupedItems = list.createGrouped(
        function groupKeySelector(item) { return item.group; },
        function groupDataSelector(item) { return resolveGroupReference(item.group); }
    );
    ...
    generategroups().forEach(function (item) {
        groupList.push(item);
    });
    ...
    function resolveGroupReference(key) {
        for (var i = 0; i < groupList.length; i++) {
            if (groupList.getAt(i).key === key) {
                return groupList.getAt(i);
            }
        }
    }
    ...
    function generategroups() {
        var groups = [
          {
              key: "Catalanas", title: "Catalanas", shortTitle: "Catalanas",
          ...
          {
              key: "Escocesas", title: "Escocesas", shortTitle: "Escocesas",
          ...
          {
              key: "Americanas", title: "Americanas", shortTitle: "Americanas",
          ...
          {
              key: "Belgas", title: "Belgas", shortTitle: "Belgas",
          ...
          {
              key: "Inglesas", title: "Inglesas", shortTitle: "Inglesas",
          ...
          {
              key: "Alemanas", title: "Alemanas", shortTitle: "Alemanas",
